defmodule CoherenceDemoWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      CoherenceDemoWeb.Coherence.ViewHelps.coherence_links/3
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers CoherenceDemoWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoherenceDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoherenceDemoWeb.Gettext, "errors", msg, opts)
    end
  end
